...
from .views import (PurchaseRequestCreateView, PurchaseRequestDeleteView,
                    ...
                    PurchaseOrderStatusUpdateView, purchase_request_view, purchase_request_close, purchase_request_open,
                    purchase_order_wizard, purchase_request_item_create, purchase_order_close, purchase_order_open,
                    purchase_order_item_create, purchase_order_transfer, purchase_order_item_close,
                    purchase_order_item_transfer, purchase_order_view)
